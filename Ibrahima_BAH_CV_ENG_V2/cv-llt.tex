...
\leftheader{%
  {\LARGE\bfseries\sffamily Ibrahima BAH} \\
  {\large\sffamily Monitoring \& Evaluation Specialist| Statistician \& Data Analyst}

  \makefield{\faEnvelope[regular]}{\href{mailto:bahi1922@gmail.com}{\texttt{bahi1922@gmail.com}}}
  % fontawesome5 doesn't have the X icon so we use
  \makefield{\faPhone}
  {(+221)  77 148 66 00 / 76 854 66 00}
  \makefield{\faLinkedin}
  {\href{https://www.linkedin.com/in/ibrahima-bah-44448b133/}{\texttt{Ibrahima BAH}}}
